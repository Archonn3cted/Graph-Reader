...
def escolhaBaseDeDados():
    ...
    if escolha == 'A':
        basedeDados = "C:/Users/Rangell/OneDrive/Documentos/teoriaDosGrafos/Bases/att48_d.txt"
        return basedeDados
    if escolha == 'B':
        basedeDados = "C:/Users/Rangell/OneDrive/Documentos/teoriaDosGrafos/Bases/dantzig42_d.txt"
        return basedeDados
    if escolha == 'C':
        basedeDados = "C:/Users/Rangell/OneDrive/Documentos/teoriaDosGrafos/Bases/fri26_d.txt"
        return basedeDados
    if escolha == 'D':
        basedeDados = "C:/Users/Rangell/OneDrive/Documentos/teoriaDosGrafos/Bases/gr17_d.txt"
        return basedeDados
    if escolha == 'E':
        basedeDados = "C:/Users/Rangell/OneDrive/Documentos/teoriaDosGrafos/Bases/p01_d.txt"
        return basedeDados
    else:
        print('-=='*10)
